import cv2                  # OpenCV, used to draw boxes and show images.
import os                   # to handle file paths.
import pickle               # to save and load Python objects as binary files.
from typing import List     
from boxinfo import BoxInfo # # a custom class (in boxinfo.py) that likely parses a line of text into: frame_ID player_ID box (x1, y1, x2, y2) category (e.g., “spike”, “block”, etc.)



dataset_root = r'D:\VollyBall Project'
