...
CHECK_POINT = "/kaggle/input/group-activity-recognition/baseline 9 (end to end)/outputs/Baseline_B9/checkpoint.pkl"
CONFIG_FILE_PATH = f'{PROJECT_ROOT}/Baselines/configs/Baseline B9.yml'
