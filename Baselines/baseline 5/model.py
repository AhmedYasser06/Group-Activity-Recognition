...
if __name__ == "__main__":
    ROOT = r"D:\VollyBall Project\project\Baselines\baseline 5" 
    MODEL_CONFIG = r"D:\VollyBall Project\project\Baselines\configs\Baseline B5.yml"    
    PERSON_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/Baselines/baseline 5/outputs/Baseline_B5_Step_A/checkpoint_epoch_8.pkl"
    GROUP_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/Baselines/baseline 5/outputs/Baseline_B5_Step_B/checkpoint_epoch_31.pkl"
