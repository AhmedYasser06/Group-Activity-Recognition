...
if __name__ == "__main__":
    ...
    MODEL_CONFIG = f"{ROOT}/Baselines/configs/Baseline B7.yml"    
    GROUP_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/modeling/baseline 7/outputs/Baseline_B7_Step_B/checkpoint_epoch_16.pkl"
