...
from model import Person_Activity_Classifer, Group_Activity_Classifer_Temporal, collate_fn

ROOT = "D:\\VollyBall Project\\project\\Baselines\\baseline 6" 
MODEL_CONFIG = f"{ROOT}/Baselines/configs/Baseline B6.yml"   
GROUP_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/Baselines/baseline 6/outputs/Baseline_B6/checkpoint_epoch_13.pkl"
CONFIG_FILE_PATH = f"{ROOT}/Baselines/configs/Baseline B6.yml"
    ...
    if checkpoint_path:
        ...
        if loaded_config:
         ...
         exp_dir = os.path.join(
                f"{PROJECT_ROOT}/modeling/baseline 6/{config.experiment['output_dir']}",
