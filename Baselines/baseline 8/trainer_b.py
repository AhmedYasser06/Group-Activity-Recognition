...
CONFIG_FILE_PATH = f"{PROJECT_ROOT}/Baselines/configs/Baseline B8.yml"
PERSON_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/Baselines/baseline 7/outputs/Baseline_B7_Step_A/checkpoint_epoch_9.pkl"
