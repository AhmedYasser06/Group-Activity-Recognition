...
if __name__ == "__main__":
    ...
    ROOT = r"D:\VollyBall Project\project\Baselines\baseline 8" 
    MODEL_CONFIG = f"{ROOT}/Baselines/configs/Baseline B8.yml"    
    GROUP_ACTIVITY_CHECKPOINT_PATH = f"{ROOT}/Baselines/baseline 8/outputs/Baseline_B8_Step_B/checkpoint.pkl"
